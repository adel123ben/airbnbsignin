...
export default function Header() {
 const {user} = useContext(UserContext);
    ...
    <span className="font-bold text-xl">Airbnb</span>
      ...
      <div className="flex items-center gap-3 cursor-pointer border border-gray-300 shadow-md rounded-full shadow-gray-300 py-2 px-4">
        <div className="">
          Anywhere
        </div>
      ...
      <Link to={ user? "/account" : "/login"} className="flex items-center gap-3 cursor-pointer border border-gray-300 shadow-md rounded-full shadow-gray-300 py-2 px-4">
